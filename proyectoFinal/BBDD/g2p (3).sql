...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2021 a las 11:44:12
...
(5, 'LOS CAGAOS', 'assets/images/logo.png', 1, 67, 0, 0, 0, 0, 'xd', 0),
(6, 'LOS INTOCABLES2', 'assets/images/logo.png', 1, 4, 0, 0, 0, 0, 'xd', 0),
(7, 'LOS INTOCABLES3', 'assets/images/logo.png', 1, 75, 0, 0, 0, 0, 'xd', 0);
...
(147, '1 VS 1', 1, 'PEPITO PALOTE LA CHUPA'),
(148, '5 VS 5', 1, '<p>\n            1.Información General <br />\n            2.Presentación <br />\n            <br />\n            2.1.Asistencia <br />\n            <br />\n            Tienes 10 minutos para poder presentarte en el chat de la hoja de\n            partido a partir de la hora indicada en \"Fecha de juego\". Una vez\n            finalizado este tiempo el rival podrá reportar como “Rival no\n            presentado”. <br />\n            <br />\n            2.2.Nombre de usuario<br />\n            <br />\n            El ID de los jugadores tiene que ser exactamente igual en la web\n            como en el cliente de juego. En el caso que no coincida en su\n            totalidad será decisión del administrador si ese jugador puede\n            disputar o no los partidos. <br />\n            <br />\n            3.Creación de partida y restricciones<br />\n            <br />\n            3.1.Creación de partida. <br />\n            <br />\n            Los partidos se deben jugar siguiendo el siguiente procedimiento:\n            <br />\n\n            • Agregar la ID del jugador rival a tu cuenta. <br />\n            • El jugador que aparezca en la parte superior de la tabla deberá\n            crear una Temporada Amistosa Online en la sección de FIFA Ultimate\n            Team e invitar al rival. <br />\n            • Se deberá seguir las normas estipuladas por el torneo. <br />\n            <br />\n            3.2. Configuración y funcionamiento. <br />\n            <br />\n            Los desafíos se deben crear con la siguiente configuración y con las\n            plantillas actualizadas. <br />\n\n            • Duración: 6 minutos por parte. <br />\n            • Tipo de partida: FIFA Ultimate Team. <br />\n            • Controles: Semiasistidos<br />\n            • Velocidad de juego: Normal<br />\n            • Tiempo: Sol / Despejado<br />\n            • En caso de empate se deberá jugar prórroga y penaltis<br />\n            <br />\n            Está prohibido el uso de la defensa clásica.\n          </p>'),
(149, '1 VS 1', 2, '<p>\n            1.Información General <br />\n            2.Presentación <br />\n            <br />\n            2.1.Asistencia <br />\n            <br />\n            El equipo entero tiene 10 minutos para poder presentarte en el chat\n            de la hoja de partido a partir de la hora indicada en \"Fecha de\n            juego\". Una vez finalizado este tiempo el rival podrá reportar como\n            “Rival no presentado”. <br />\n            <br />\n            2.2.Nombre de usuarios<br />\n            <br />\n            El ID de los jugadores tiene que ser exactamente igual en la web\n            como en el cliente de juego. En el caso que no coincida en su\n            totalidad será decisión del administrador si ese jugador puede\n            disputar o no los partidos. <br />\n            <br />\n            3.Creación de partida y restricciones<br />\n            <br />\n            3.1.Creación de partida. <br />\n            <br />\n            Los partidos se deben jugar siguiendo el siguiente procedimiento:\n            <br />\n\n            • Agregar la ID del jugador rival a tu cuenta. <br />\n            • El equipo que aparezca en la parte superior de la tabla deberá\n            crear una Temporada Amistosa Online en la sección de FIFA Ultimate\n            Team e invitar al rival. <br />\n            • Se deberá seguir las normas estipuladas por el torneo. <br />\n            <br />\n            3.2. Configuración y funcionamiento. <br />\n            <br />\n            Los desafíos se deben crear con la siguiente configuración y con las\n            plantillas actualizadas. <br />\n\n            • Duración: 6 minutos por parte. <br />\n            • Tipo de partida: FIFA Ultimate Champions. <br />\n            • Controles: Semiasistidos<br />\n            • Velocidad de juego: Normal<br />\n            • Tiempo: Sol / Despejado<br />\n            • En caso de empate se deberá jugar prórroga y penaltis<br />\n            <br />\n          </p>'),
(150, '11 VS 11', 1, 'PEPITO PALOTE LA CHUPA'),
(153, '11 VS 11', 1, 'PEPITO PALOTE LA CHUPA');
...
(75, 'elpepe', 'elpepe', 'elpepe', 'assets/images/elpepe751610096221840elpepe.jpg', '2016-01-20', 'elpepe@gmail.com', 'Peru', 'vVOQRWUkcaZ7Ai3lrZi9cA==', 'elpepeasasdasdadsads', 'user', 0, 70),
(76, 'xpepe', 'Luis', 'Fernandez', 'assets/images/logo.png', '1999-10-21', 'pepitopalote@gmail.com', 'Espana', 'vVOQRWUkcaZ7Ai3lrZi9cA==', 'melachupas', 'user', 1, 100),
...
--
ALTER TABLE `reglas`
  MODIFY `reglas_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
...
--
ALTER TABLE `partidos`
  ADD CONSTRAINT `partidos_ibfk_1` FOREIGN KEY (`equipo_first`) REFERENCES `usuarios` (`usuario_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `partidos_ibfk_2` FOREIGN KEY (`equipo_second`) REFERENCES `usuarios` (`usuario_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `torneos`
  ADD CONSTRAINT `torneos_ibfk_1` FOREIGN KEY (`reglas_id`) REFERENCES `reglas` (`reglas_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `torneos_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `juegos` (`juego_id`);
COMMIT;
